        ...
        <section className="container mx-auto lg:flex mx-auto text-center items-baseline mb-4 mt-4">
            <div className="h-25 lg:w-1/5 rounded overflow-hidden">
                ...
                <div class="px-6 pb-8">
                    ...
                    <p class="text-gray-700 text-sm">The suite of apps providing shared infrastructure is licensed under the Platform Commons License</p>
                </div>
            </div>
            ...
            <div className="lg:w-1/5 rounded overflow-hidden">
                ...
                <div class="px-6 pb-8">
                    ...
                    <p class="text-gray-700 text-sm">The platform facilitates interactions between civil society,government bodies and the marketplace</p>
                </div>
            </div>
            ...
            <div className="lg:w-1/5 rounded overflow-hidden">
                ...
                <div class="px-6 pb-8">
                    ...
                    <p class="text-gray-700 text-sm">Intuitive app design, open access to knowledge resources and 6C model provides framework for scaling</p>
                </div>
            </div>
